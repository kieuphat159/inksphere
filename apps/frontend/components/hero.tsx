        ...
        <div className="bg-gradient-to-br from-sky-500 to-indigo-500 text-white pt-12">
            <div className="container mx-auto flex flex-col md:flex-row items-center flex-wrap px-3">
                ...
                <div className="flex flex-col w-full justify-center items-start md:w-2/5 text-center md:text-left">
                    ...
                    <h2 className="my-5 text-5xl font-bold leading-tight">Welcome To KieuPhat159 Blog</h2>
                    <p className="capitalize leading-normal text-2xl">
                        Join a community that thrives on learrning, creating and growing together.
                    </p>
                </div>

                {/* Right col */}
                <div className="w-full flex justify-center text-center py-7 md:w-3/5">
                    <img src="/hero.png" alt="hero img" className="w-full md:w-3/4 z-30" />
                </div>
            </div>
